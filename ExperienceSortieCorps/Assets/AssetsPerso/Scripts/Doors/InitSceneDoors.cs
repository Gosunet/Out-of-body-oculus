...
public class InitSceneDoors : MonoBehaviour
{
    ...
    private const float _standardHeight = 17;
    ...
    {
        _doorIndex = UnityEngine.Random.Range(0, _listRandomDistance.Count);
